...
void example_log_handle_console(int write_type, int fmt_flag)
{
...
void example_log_handle_file(int write_type, int fmt_flag, const char *path)
{
	muggle_log_handle_t handle;
...
int main()
{
	...
	{
		example_log_handle_console(i, fmt);
	}
